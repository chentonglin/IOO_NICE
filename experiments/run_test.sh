...
function func_basic {
    ...
    path_data=$folder_data'/'$mode_occlude'_'$mode_color'/'$mode_object'.h5'
    for train in 1 0; do
        python $run_file \
...
for mode_occlude in 'occ'; do
    # for mode_color in 'gray' 'rgb_1' 'rgb_2' 'rgb_3' 'rgb_4'; do
    # for mode_color in 'rgb_4'; do
    for mode_color in 'abstract'; do
        # for mode_object in 'shapes' 'mnist'; do
        # for mode_object in 'mnist'; do
        for mode_object in 'abstract'; do
